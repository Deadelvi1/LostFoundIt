        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO items (
                    ...
                    date_reported, 
                    status
                ) VALUES (?, ?, ?, 'found', ?, ?, CURDATE(), 'available')
            ");
...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow p-6 w-full">
        ...
        <form method="POST" action="" class="bg-white p-8 rounded-lg shadow-md w-full max-w-5xl mx-auto" id="reportForm" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500" 
                          ...
                          name="description" 
                          rows="4"
                          placeholder="Jelaskan detail barang yang ditemukan, seperti ciri-ciri khusus, warna, ukuran, dll."
                          required></textarea>
            </div>
        </form>
        ...
        <div class="w-full max-w-5xl mx-auto flex justify-end items-center gap-4 mt-6">
            ...
            <button type="submit" form="reportForm" class="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-6 rounded transition duration-200">Laporkan Barang Ditemukan</button>
        </div>
    </main>
